...
void Copter::land_run_vertical_control(bool pause_descent)
{
    ...
    if (!pause_descent) {
        ...
        cmb_rate = AC_AttitudeControl::sqrt_controller(LAND_START_ALT-alt_above_ground, g.p_alt_hold.kP(), pos_control->get_accel_z()*0.25f);
...
void Copter::land_run_horizontal_control(bool fixed_yaw, float yaw_command_cd)
{
